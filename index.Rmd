...
The "Heatmap" shows the variation among Indiana's top counties by children ages 0 to 4. The comparisons are by column. Look for the bright yellows and dark blues within a single column.  Also, look to see how the algorithm grouped the counties and variables with the dendrogram in the margins.
...
Thanks, recognition and acknowledgement are given to the following people and organizations:
